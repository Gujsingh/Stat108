...
```{r eval = TRUE}
ggplot(data = data, aes(x =ChronicAbsenteeismRate)) + geom_histogram() +
...
ggplot(data = data, aes(x =average2021)) +
  geom_histogram() +
...
ggplot(data = data, aes(y = average2021, x = `Average Days Absent`)) +
               geom_point() +
               labs(title = "Houisng Price vs Average Days Absent")
ggplot(data = data, aes(y = average2021, x = ChronicAbsenteeismRate)) +
               geom_point() +
               labs(title = "Houisng Price vs Chronic Absents")
ggplot(data = data, aes(y = average2021, x = `Dropout (Rate)`)) +
               geom_point() +
               labs(title = "Houisng Price vs Dropout Rate")
ggplot(data = data, aes(y = average2021, x = `Non-Stability Rate (percent)`)) +
               geom_point() +
               labs(title = "Houisng Price vs Non stability rate")
ggplot(data = data, aes(y = average2021, x = `Mean Scale Score`)) +
               geom_point() +
               labs(title = "Houisng Price vs Mean scale score")
```
...
```{r eval = TRUE}
ggplot(data = reg_model, aes(x = reg_model$fitted.values)) +
  geom_histogram() +
  labs(x = "Fitted",
...
ggplot(data = reg_model2, aes(x = reg_model2$fitted.values)) +
  geom_histogram() +
  labs(x = "Fitted",
       y = "Fitted value Count",
...
ggplot(data = reg_model3, aes(x = reg_model3$fitted.values)) +
  geom_histogram() +
  labs(x = "Fitted",
       y = "Fitted value Count",
