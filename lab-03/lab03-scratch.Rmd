...
ggplot(data = elmhurst, aes(x = gift_aid)) +
  geom_histogram() +
  labs(x = "Gift Aid(Thousand $)", y = "Number Of Observations", title = "Gift Distribution")
```
...
ggplot(data = elmhurst, mapping = aes(x =family_income, y = gift_aid)) +
  geom_point() +
  labs(x ="Family Income", y="Gift Aid", title="Gift_Aid VS Family_Income")
```
...
```{r eval=FALSE}
ggplot(data=elmhurst, mapping = aes(x =family_income, y= residuals(reg_model))) +
  geom_point() + 
